...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirlineV2.Models.Aircraft", b =>
                {
                    b.Property<int>("AcID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AirlineV2.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("AirlineV2.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("AirlineV2.Models.Flight", b =>
                {
            ...
            modelBuilder.Entity("AirlineV2.Models.FlightAssignedTo", b =>
                {
            ...
            modelBuilder.Entity("AirlineV2.Models.Flight", b =>
                {
                    b.HasOne("AirlineV2.Models.Aircraft", "aircraft")
                        .WithMany()
                        .HasForeignKey("AcID")
            ...
            modelBuilder.Entity("AirlineV2.Models.FlightAssignedTo", b =>
                {
                    b.HasOne("AirlineV2.Models.Employee", "employee")
                        .WithMany("FlightsAssigned")
                        .HasForeignKey("EmpID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AirlineV2.Models.Flight", "flight")
                        .WithMany()
                        .HasForeignKey("FlgID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
